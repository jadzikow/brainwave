...
class Classifier:
    ...
    def __init__(self, class_names, train_from_scratch=False):
        ...
        if train_from_scratch:
            ...
            X, Y = load_data("data/5way/train", class_names, is_directory=True, classes_in_subdirs=True, interval_seconds=2, step_size=32)
            ...
            test_X, test_Y = load_data("data/5way/test", class_names, is_directory=True, classes_in_subdirs=True, interval_seconds=2, step_size=32)
            ...
            train_model(x, y, is_training, brainwave_mlp_model, X, Y, test_X, test_Y, n_classes=n_classes, num_epochs=400, batch_size=1000, save_path=saved_model_path)
